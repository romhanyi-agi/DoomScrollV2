...
namespace DoomScroll_V2.Common
{
    ...
    internal class ScreenshotOverlay
    {
        public static CustomButton CreateCameraButton(HudManager hud)
        {
            ...
            Sprite[] cameraBtnSprites = ImageLoader.ReadImageSlicesFromAssembly(Assembly.GetExecutingAssembly(), "DoomScroll_V2.Assets.cameraFlash.png", slices);
        ...
        {
            Vector4[] slices = { new Vector4(0, 0.5f, 1, 1), new Vector4(0, 0, 1, 0.5f) };
            Sprite[] captureSprite = ImageLoader.ReadImageSlicesFromAssembly(Assembly.GetExecutingAssembly(), "DoomScroll_V2.Assets.captureScreenNew.png", slices);
        ...
        public static GameObject InitCameraOverlay(HudManager hud)
        {
            ...
            Sprite spr = ImageLoader.ReadImageFromAssembly(Assembly.GetExecutingAssembly(), "DoomScroll_V2.Assets.cameraOverlay.png");
            sr.sprite = spr;
