...
namespace DoomScroll_V2.Common
{
    ...
    public class File : IDirectory
    {
        ...
        public File(string parentPath, GameObject parentPanel, string name, byte[] image, FileType fileType)
        {
            ...
            Sprite[] shareBtnImg = ImageLoader.ReadImageSlicesFromAssembly(Assembly.GetExecutingAssembly(), "DoomScroll_V2.Assets.shareButton.png", slices);
        ...
        public void DisplayContent()
        {
            ...
            switch (m_type)
            {
                case FileType.IMAGE:
                    ...
                    ImageSender.RpcSendChatImage(m_content);
                    return;
