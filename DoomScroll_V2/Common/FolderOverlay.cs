...
namespace DoomScroll_V2.Common
{
    ...
    public static class FolderOverlay
    {
        ...
        public static CustomButton CreateFolderBtn(GameObject parent)
        {
            ...
            Sprite[] btnSprites = ImageLoader.ReadImageSlicesFromAssembly(Assembly.GetExecutingAssembly(), "DoomScroll_V2.Assets.folderToggle.png", slices);
        ...
        public static GameObject CreateFolderOverlay(GameObject parent)
        {
            ...
            Sprite spr = ImageLoader.ReadImageFromAssembly(Assembly.GetExecutingAssembly(), "DoomScroll_V2.Assets.folderOverlay.png");
            sr.sprite = spr;
        ...
        public static CustomButton AddCloseButton(GameObject parent)
        {
            ...
            Sprite[] closeBtnImg = { ImageLoader.ReadImageFromAssembly(Assembly.GetExecutingAssembly(), "DoomScroll_V2.Assets.closeButton.png") };
        ...
        public static CustomButton AddHomeButton(GameObject parent)
        {
            SpriteRenderer sr = parent.GetComponent<SpriteRenderer>();
            Vector4[] slices = { new Vector4(0, 0.5f, 1, 1), new Vector4(0, 0, 1, 0.5f) };
            Sprite[] homeBtnImg = ImageLoader.ReadImageSlicesFromAssembly(Assembly.GetExecutingAssembly(), "DoomScroll_V2.Assets.homeButton.png", slices);
        ...
        public static CustomButton AddBackButton(GameObject parent)
        {
            SpriteRenderer sr = parent.GetComponent<SpriteRenderer>();
            Vector4[] slices = { new Vector4(0, 0.5f, 1, 1), new Vector4(0, 0, 1, 0.5f) };
            Sprite[] backBtnImg = ImageLoader.ReadImageSlicesFromAssembly(Assembly.GetExecutingAssembly(), "DoomScroll_V2.Assets.backButton.png", slices);
